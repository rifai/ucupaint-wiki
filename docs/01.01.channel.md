...
|![02.channel-overview.02](./source/02.channel-overview.02.1.gif)|
|:--:|
|Multiple Normal Vector Sisplacement Outputs when Displacement Setup is active| {align=center}

The base color/value of the channel is actually the default input of the node, as demonstarated on the gif below.
...
*If you notice that normal has a default value of (999, 999, 999), just ignore that, it's basically a litlle hack to make the normal channel work properly.* 
